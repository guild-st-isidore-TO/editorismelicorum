...
\include "../build/ly/marian_ant_sim_vars.ly"
  ...
  \bookpart {
    ...
    \header {
      title =  \markup \center-column { 
        \vspace #2
        "ANTIPHONAE MARIAE (IN TONO SIMPLICI)"
        \italic "Marian Antiphon (in Simple Tone)"
        \vspace #1
    ...
    \markup \vspace #1
    \markup \wordwrap {
      As initial steps, the Editoris project is building proofs of concept:
    ...
    \markup \left-column {
      ...
      \line { \bold "excud." "--- excudit" \italic ", struck/engraved by" }
    }
  }
